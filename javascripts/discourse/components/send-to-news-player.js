...
export default class SendToNewsPlayer extends Component {
  ...
  get desktopEmbedCode() {
    ...
    const embedCode = isMobile ? settings.mobile_embed_code : settings.desktop_embed_code;
    return embedCode;
  }
